...
struct Event {
    ...
    var duration: String {
        ...
        let dateExhibitionBegin = calendar.date(byAdding: .month,
                                                value: Constants.exhibitionBeginMonth,
                                                to: Constants.currentDate) ?? Constants.currentDate

        let dateExhibitionEnd = calendar.date(byAdding: .month,
                                              value: Constants.exhibitionEndMonth,
                                              to: Constants.currentDate) ?? Constants.currentDate
